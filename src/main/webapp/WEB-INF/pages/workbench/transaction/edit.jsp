    ...
    <script type="text/javascript">
        $(function () {
				...
				source: function (jquery, process) {
					...
					$.ajax({
						...
						success: function (response) {
							...
							$("#create-accountName").prop("contactsId",response.data.id);
            ...
            $("#searchActivityTxt").keyup(function () {
                var contactsName = $("#searchActivityTxt").val();
                $.ajax({
            ...
            $("#findContacts").keyup(function () {
                var contactsName = $("#findContacts").val();
                $.ajax({
            ...
            $("#updateCommit").click(function () {
                ...
                // }
                $.ajax({
                    url: "transaction/updateTran/update.json",
                    data: {
                        id: id,
                        owner: owner,
                        money: money,
            ...
            <div class="modal-body">
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;"
                                   placeholder="请输入联系人名称，支持模糊查询" id="findContacts">
                            <span class="glyphicon glyphicon-search form-control-feedback"></span>
                        </div>
                    </form>
                </div>
...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        <button type="button" class="btn btn-primary" id="updateCommit">保存</button>
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        <label for="create-accountName" class="col-sm-2 control-label">客户名称<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-accountName" contactsId=""
    ...
    <div class="form-group">
        ...
        <label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a
                href="javascript:void(0);" data-toggle="modal" id="findActivity"><span
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a
                href="javascript:void(0);" data-toggle="modal" id="searchContacts"><span
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
