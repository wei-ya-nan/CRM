...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updateRemarkBtn").click(function () {
			...
			$.ajax({
				url: "contacts/remark/update.json",
				data: {
					id: id,
		...
		$("#remarkDivList").on("click", "a[name=delete_remark]", function () {
			...
			/*alert(id);*/
			$.ajax({
				url: "contacts/detail/remark/delete.json",
				data: {
					id: id
				},
				type: "post",
...
<body>
						...
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;"
								   placeholder="请输入市场活动名称，支持模糊查询" id="searchActivityTxt">
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${contacts.createBy}&nbsp;
				&nbsp;</b><small
		...
		<div style="position: relative; left: 40px; height: 30px; top: 50px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${contacts.editBy}&nbsp;
				&nbsp;</b><small
		...
		<div style="position: relative; left: 40px; height: 30px; top: 80px;">
			...
			<div
					style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${contacts
					.nextContactTime}&nbsp;</b></div>
...
<%--		</div>--%>
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="contacts/save.html?customerId=${contacts2.customerId}" style="text-decoration: none;"
				   id="createTranBtn"><span
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" data-toggle="modal" id="saveRelationBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
